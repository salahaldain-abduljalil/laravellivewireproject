<nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
    <a href="{{ route('front.index') }}" class="navbar-brand p-0">
        ...
        <!-- <img src="{{asset("front-asset")}}/img/logo.png" alt="Logo"> -->
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav mx-auto py-0">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle @yield('teamtest')" data-bs-toggle="dropdown">Pages</a>
                <div class="dropdown-menu m-0">
                    <a href="{{ route('front.team') }}" class="dropdown-item">Our Team</a>
                    <a href="{{ route('front.testmonial') }}" class="dropdown-item">Testimonial</a>
                </div>
            </div>
            <a href="{{ route('front.contact') }}" class="nav-item nav-link @yield('contact')">Contact</a>
        </div>
